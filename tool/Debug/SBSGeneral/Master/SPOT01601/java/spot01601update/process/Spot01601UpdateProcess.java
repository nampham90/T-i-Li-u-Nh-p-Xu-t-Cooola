package jp.co.brycen.wms.spot01601update.process;
...
import jp.co.brycen.wms.spot01601.dto.Spot01601ExclusionConditionDto;
import jp.co.brycen.wms.spot01601.dto.Spot01601ExclusionResultDto;
import jp.co.brycen.wms.spot01601.process.Spot01601ExclusionProcess;
 ...
 * 概要：
 */
public class Spot01601UpdateProcess extends AbstractProcess{
	public Spot01601UpdateProcess(ILogSender logSender) {
		super(logSender);
	}
	...
	protected void beforeProcess(DBAccessor dba, AbstractRequest request, AbstractResponse response,
		...
		Spot01601UpdateRequest reqSpot01601Update = (Spot01601UpdateRequest) request;

		// Cast to exclusion request
		Spot01601ExclusionConditionDto reqSpot01601Exclusion = new Spot01601ExclusionConditionDto();
		reqSpot01601Exclusion.accessInfo = reqSpot01601Update.accessInfo;
		reqSpot01601Exclusion.CSTMCD = request.accessInfo.CSTMCD;
		
     String rasncd = reqSpot01601Update.spot01601UpdateCondition.RASNCD;
     String rasnnm = reqSpot01601Update.spot01601UpdateCondition.RASNNM;
     String soplndate = reqSpot01601Update.spot01601UpdateCondition.SOPLNDATE;
     String shipmntplndate = reqSpot01601Update.spot01601UpdateCondition.SHIPMNTPLNDATE;
     String incdntplnno = reqSpot01601Update.spot01601UpdateCondition.INCDNTPLNNO;
     String soordno = reqSpot01601Update.spot01601UpdateCondition.SOORDNO;
     String prcsno = reqSpot01601Update.spot01601UpdateCondition.PRCSNO;
     String cstmordno = reqSpot01601Update.spot01601UpdateCondition.CSTMORDNO;
     String sogrpno = reqSpot01601Update.spot01601UpdateCondition.SOGRPNO;
     String pckusrcd = reqSpot01601Update.spot01601UpdateCondition.PCKUSRCD;
     String pckngdatetime = reqSpot01601Update.spot01601UpdateCondition.PCKNGDATETIME;
     String btno = reqSpot01601Update.spot01601UpdateCondition.BTNO;
     String datesralno = reqSpot01601Update.spot01601UpdateCondition.DATESRALNO;
     String inno = reqSpot01601Update.spot01601UpdateCondition.INNO;
     String pcknglstno = reqSpot01601Update.spot01601UpdateCondition.PCKNGLSTNO;

		Spot01601ExclusionProcess procSpot01601Exclusion = new Spot01601ExclusionProcess(this);
		Spot01601ExclusionResultDto resSpot01601Exclusion = (Spot01601ExclusionResultDto) procSpot01601Exclusion
				.execute(dba, reqSpot01601Exclusion, response);

		List<ErrorDto> msg = new ArrayList<ErrorDto>();
		if (!resSpot01601Exclusion.ret) {
	...
	public AbstractResponse process(DBAccessor dba, AbstractRequest request, AbstractResponse response,
		...
		Spot01601UpdateResponse resSpot01601Update = (Spot01601UpdateResponse) response;
		return resSpot01601Update;
	}

	@Override
	protected AbstractResponse createNewResponse(AbstractRequest request) {
		return new Spot01601UpdateResponse();
	}
 ...
 integer index = 0;
     if (!ValidateUtility.CheckNull(rasncd)) { 
         index++;
         ps.setString(index, rasncd);
     } 
         index++;
         ps.setString(index, rasnnm);
     if (!ValidateUtility.CheckNull(soplndate)) { 
         index++;
         ps.setString(index, soplndate);
     } 
     if (!ValidateUtility.CheckNull(shipmntplndate)) { 
         index++;
         ps.setString(index, shipmntplndate);
     } 
     if (!ValidateUtility.CheckNull(incdntplnno)) { 
         index++;
         ps.setString(index, incdntplnno);
     } 
     if (!ValidateUtility.CheckNull(soordno)) { 
         index++;
         ps.setString(index, soordno);
     } 
     if (!ValidateUtility.CheckNull(prcsno)) { 
         index++;
         ps.setString(index, prcsno);
     } 
     if (!ValidateUtility.CheckNull(cstmordno)) { 
         index++;
         ps.setString(index, cstmordno);
     } 
     if (!ValidateUtility.CheckNull(sogrpno)) { 
         index++;
         ps.setString(index, sogrpno);
     } 
     if (!ValidateUtility.CheckNull(pckusrcd)) { 
         index++;
         ps.setString(index, pckusrcd);
     } 
     if (!ValidateUtility.CheckNull(pckngdatetime)) { 
         index++;
         ps.setString(index, pckngdatetime);
     } 
     if (!ValidateUtility.CheckNull(btno)) { 
         index++;
         ps.setString(index, btno);
     } 
     if (!ValidateUtility.CheckNull(datesralno)) { 
         index++;
         ps.setString(index, datesralno);
     } 
     if (!ValidateUtility.CheckNull(inno)) { 
         index++;
         ps.setString(index, inno);
     } 
     if (!ValidateUtility.CheckNull(pcknglstno)) { 
         index++;
	...
	protected void updateBuyerHistory(DBAccessor dba, AbstractRequest request) throws FatalException, DBException, ProcessCheckErrorException {
     ...
     String pcknglstno = reqSpot01601Update.spot01601UpdateCondition.PCKNGLSTNO;
			...
			String seqno = getSequence(dba, reqSpot01601Update, "MTHS");
 ...
 integer index = 0;
	 ...
	 */
	private String getSequence(DBAccessor dba, Spot01601UpdateRequest request, String prefix)
