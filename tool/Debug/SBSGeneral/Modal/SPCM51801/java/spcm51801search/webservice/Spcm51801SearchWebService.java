...
import jp.co.brycen.wms.spcm51801search.process.Spcm51801SearchProcess; 
 
@Path("wms") 
public class Spcm51801SearchWebService extends AbstractWebService { 
 
	@POST 
	@Path("/Spcm51801Search") 
	...
	protected AbstractProcess getProcess() { 
		return new Spcm51801SearchProcess(this); 
	} 
} 
